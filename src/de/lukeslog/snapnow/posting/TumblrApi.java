...
import de.lukeslog.snapnow.main.MainActivity;
...
/**
 * https://raw.github.com/FredrikL/android-ttTumblr/master/src/com/tacticalnuclearstrike/tttumblr/TumblrApi.java
 * 
 * @author FredrikL
 *
 */
...
{
	public static final String TAG = SnapNowConstants.TAG;
	public static final String BLOGS_PREFS = "blogs";
	public static final String GENERATOR = "SnapNow"; // user-agent string.
	...
	{
		return getSharePreferences().getString("tumblrusername", "");
	}

	public String getPassword() 
	{
		return getSharePreferences().getString("tumblrpassword", "");
	}

	private SharedPreferences getSharePreferences() 
	{
        return context.getSharedPreferences(SnapNowConstants.PREFS, 0);
	}
	...
	public boolean validateUsernameAndPassword(String Username, String Password) 
	{
		...
		try 
		{
			...
			SharedPreferences blogs = this.context.getSharedPreferences(BLOGS_PREFS, 0);
			Log.d(TAG, "attempting blog list extraction");
	...
	public boolean postText(String title, String body, Bundle options) 
	{
		...
		{
			ShowNotification(TAG, "Text creation failed", "");
			return false;
		}
		return true;
	}
